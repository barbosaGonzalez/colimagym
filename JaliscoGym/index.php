...
$is_index = true;
$estado = 2; //1-> Colima, 2->Jalisco, 3->Durango, 4->Tuxtla
if($estado == 1){
...
?>
	...
	<section>
		<div class="container buscador text-center">
			...
			<p>
				Aquí podras encontrar las coordenadas de algunos gimnasios de Jalisco para Pokémon Go
			</p>
				...
				<?php foreach ($conn->query('SELECT nombre, alterno, latlong, ex, imagen FROM Gimnasios where municipio_id = '.$municipio['municipio_id']) as $gimnasio){ ?>
					<div class="carton col-xs-12 col-lg-4 col-md-4 col-sm-4">
						...
						<div class="card-body">
							...
							<img class="rounded-circle img-fluid d-block mx-auto" src="<?php base_url($gimnasio['imagen']) ?>" alt="<?php echo $gimnasio['nombre'] ?>">
